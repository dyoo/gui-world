...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname tshirt) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(require "../../gui-world.ss")
(require "fabric-teachpack.scm")
