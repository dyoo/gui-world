...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname flag-6-inject) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
