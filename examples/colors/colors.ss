...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname colors) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
(define (make-color-gui world-color update-world-color)
  (local [(define (world-color-red a-world)
          ...
          (define (update-world-color-red a-world a-val)
            (update-world-color a-world
                                (update-color-red (world-color a-world)
                                                  a-val)))
